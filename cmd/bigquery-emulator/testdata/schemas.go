...
var (
	...
	ComplexTypeSchema = bigquery.Schema{
		{
	...
	WithWellKnownTypesSchema = bigquery.Schema{
	...
	ExternalEnumMessageSchema = bigquery.Schema{
		{
			Name: "msg_a",
			Type: bigquery.RecordFieldType,
			Schema: bigquery.Schema{
	...
	ValidationBaseSchema = bigquery.Schema{
		{
			Name: "double_field",
	...
	ValidationRepeatedSchema = bigquery.Schema{
		{
			Name: "id",
			Type: bigquery.IntegerFieldType,
		},
	...
	ValidationColumnAnnotations = bigquery.Schema{
		{
			Name: "first",
			Type: bigquery.StringFieldType,
		},
	...
	ExampleEmployeeSchema = bigquery.Schema{
		{
			Name: "id",
			Type: bigquery.IntegerFieldType,
		},
